###################################################################
!Y+X on GameCube Controller = short hop [DukeItOut, Sammi Husky]
###################################################################
# Modified by Sammi Husky to remove the actual macro. We just use
# this for the additional PSA button "L+R"
###################################################################
#
