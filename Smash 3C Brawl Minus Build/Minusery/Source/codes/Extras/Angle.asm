Angle 0x200/0x202 and 0x201/0x203 are inwards and outwards sending autolinks, 0x202 and 0x203 are based on distance from centre and users speed [Eon, SammiHusky]
#
# Edited by SammiHusky to fix crash when hitting DDD minions
#
HOOK @ $8076B57C
{
    beq %end%
...
#setupDamageStatusNormal/[wnDamageTransactorActor]
HOOK @ $808e789c
{
    lfs f2, 0x7C(r24) # original instruction
    mr r6, r24
}