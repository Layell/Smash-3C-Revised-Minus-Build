#.include Source/codes/Extras/CostumeAddition.asm # If trying to add more than 15 costumes, use this code to load all costumes from the result portraits, instead of the CSS file.
...
#.include Source/codes/Extras/AI/AiDebug.asm 		# Displays AI debug for CPU in P1 slot. Incompatible with CodeMenu.asm (In RSBE01.txt). One or the other must be ignored with # in front of .include

#.include Source/codes/Extras/USBGecko.asm 		# Adds support for Gecko codes passed in by a USB Gecko

.include Source/codes/Extras/AllStar.asm
.include Source/codes/Extras/Angle.asm
.include Source/codes/Extras/CustomEnding.asm
.include Source/codes/Extras/Maths.asm
.include Source/codes/Extras/SoundbankFix.asm
.include Source/codes/Extras/VariableParameter.asm
#.include Source/codes/Extras/BigHeadMode.asm
#.include "Source/codes/Extras/Input Buffer.asm"
#.include Source/codes/Extras/RandomAngleMode.asm
#.include Source/codes/Extras/ScaleModifier.asm
#.include Source/codes/Extras/SpeedModifier.asm
#.include Source/codes/Extras/WarMode.asm
.include Source/codes/Extras/ShortHopMacro.asm
