...
HOOK @ $80952F38
{
    %StockException (0x50, 0x32)    #Ridley
...
{
    %GFXFix (0x41, 0x178)   #Mewtwo
	%GFXFix (0x50, 0x187)   #Ridley
    lis r3, 0x158            #If no fix is specified, use Lucario's (modified in Minus)
}
...
#awkward memory stuff to get to LA-Basic[72] of the projectile
  ...
  %GFXFix(0x41, 0x96) #MewtwoHat
  %GFXFix(0x50, 0x97) #RidleyHat
lucarioHat:
notKirby:
  lis r3, 0x123
...
{
	#%BoneIDFixA(r3, 0x41, 0x46)		#Mewtwo
	%BoneIDFixA(r3, 0x50, 0x1A)		#Ridley
...
HOOK @ $80AA9D98		#Use Register 7, followed by Fighter ID and Bone ID
{
	...
	lwz r7, 0x0C (r7)
	lwz r7, 0x24 (r7)
	#%BoneIDFixA(r7, 0x41, 0x46)		#Mewtwo
	%BoneIDFixA(r7, 0x50, 0x1A)		#Ridley
...
#.include Source/codes/Extras/KirbyHatEx.asm
...
HOOK @ $806E29D0		# Character trophy to load for Classic
{
  ...
  li r29, Dark_Samus_Trophy;cmpwi r28, Dark_Samus_Slot;beq+ GotTrophy	# if it's Dark Samus's P+Ex slot 
