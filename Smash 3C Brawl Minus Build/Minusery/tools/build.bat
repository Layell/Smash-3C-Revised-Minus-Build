...
ECHO 5.  Build Minimal Release (Build All and clean everything unnecessary)
ECHO -------------------------------------
...
IF /I '%INPUT%'=='5' GOTO BuildMinimalRelease
...
robocopy "./" "./build/Minusery/" "gc.txt" "RSBE01.txt" "RSBE01.gct" "build.bat"
...
:: Call this build edition or Netplay edition? Idk - OUTPUTS TO build FOLDER
